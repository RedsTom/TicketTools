...
public class NextPageHandler implements IInteractionAction<ButtonInteractionEvent> {

  private final HelpManager helpManager;

  @Override
  public void run(ButtonInteractionEvent event) {
    event.deferEdit().setEmbeds(helpManager.getNextPage(event.getMessageIdLong())).queue();
  }
}
